...
export default async function WebsiteAboutPage() { await requireAdminPage("website.manage"); return <WebsitePageEditor pageKey="about" initialItem={await getWebsitePage("about")} />; }
